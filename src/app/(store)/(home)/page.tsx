...
async function getFeaturedProducts(): Promise<Product[]> {
  const response = await api('/products/featured', {
    next: {
      ...
      // a cada 1 hora todo mundo que acessar a página home vai estar acessando os mesmos dados
      // a cada 1 hora a requisição do backend será feita uma 1 unica vez
    },
  })
...
export default async function Home() {
  // highLightedProduct -> produto em destaque
